...
export const seedBillingRules: BillingRule[] = [
  {
    ...
    serviceFeeFormula: 'schedule_hours * manage_service_rate + grab_hours * grab_manage_rate',
    enabled: true,
    isDefault: true,
  ...
  },
  {
    ...
    serviceFeeFormula: 'task_count * task_service_rate',
    enabled: true,
  ...
  },
  {
    ...
    serviceFeeFormula:
      'schedule_hours * manage_service_rate + grab_hours * grab_manage_rate + task_count * task_service_rate',
    enabled: true,
