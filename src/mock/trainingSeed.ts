...
export const seedExamQuestions: ExamQuestion[] = [
  {
    ...
    examId: 'te_001',
    type: 'single',
    content: '观察图片，图中加油站存在什么安全隐患？应如何处理？',
    imageUrl: EXAM_SCENE_IMAGES.missingExtinguisher,
    options: [
      { key: 'A', text: '加油区未配置灭火器，应立即补齐并登记巡检' },
      { key: 'B', text: '员工未穿工服，仅需口头提醒即可' },
      { key: 'C', text: '地面有少量油渍，可等下班再清理' },
      { key: 'D', text: '无安全隐患，继续作业' },
    ],
    correctAnswers: ['A'],
    score: 15,
    explanation: '加油区必须配备有效灭火器并定期检查，发现缺失应立即补齐。',
    source: 'manual',
    createdAt: weekAgo,
  },
  {
    ...
    examId: 'te_001',
    type: 'multiple',
    content: '观察图片，以下哪些属于加油站现场违规行为？（多选）',
    imageUrl: EXAM_SCENE_IMAGES.violations,
    options: [
      { key: 'A', text: '加油区吸烟' },
      { key: 'B', text: '规范佩戴安全帽和反光背心' },
      { key: 'C', text: '使用手机接打电话' },
      { key: 'D', text: '车辆熄火后加油' },
    ],
    correctAnswers: ['A', 'C'],
    score: 20,
    partialScore: true,
    explanation: '加油区严禁吸烟和使用手机，必须制止并上报班组长。',
    source: 'manual',
    createdAt: weekAgo,
  },
  {
    ...
    options: [
      { key: 'A', text: '油枪未归位且未关闭阀门，应立即归位并关闭' },
      { key: 'B', text: '加油速度偏慢，应加快操作' },
      { key: 'C', text: '顾客未出示证件，可继续加油' },
      { key: 'D', text: '操作规范，无需处理' },
    ],
    correctAnswers: ['A'],
    score: 15,
    explanation: '加油结束后必须挂枪、关闭阀门，防止跑冒滴漏。',
    source: 'manual',
    createdAt: weekAgo,
  },
  {
