...
export const seedAttendanceGroups: AttendanceGroup[] = [
  {
    id: 'ag_hq',
    code: 'HQ-ATT-001',
    name: '县区考勤组',
  ...
  },
  {
    ...
    attendanceType: 'shift',
    shiftTemplates: [
      { id: 'st_am', name: '早班', startTime: '08:00', endTime: '17:00', breakRule: '上下午各休15分钟', workHours: 9, requiredHeadcount: 31 },
      { id: 'st_pm', name: '中班', startTime: '14:00', endTime: '23:00', breakRule: '晚餐休30分钟', workHours: 9, requiredHeadcount: 24 },
      { id: 'st_night', name: '大晚班', startTime: '22:00', endTime: '07:00', breakRule: '夜宵休30分钟', workHours: 9, requiredHeadcount: 12 },
    ],
    gpsEnabled: true,
    gpsRadiusMeters: 300,
    punchLocations: [
