...
export const permissionCatalog: PermissionNode[] = [
  ...
  { id: 'perm_enterprise_list', name: '企业列表', code: 'enterprise:list', module: '企业管理', parentId: 'perm_enterprise', type: 'menu' },
  { id: 'perm_enterprise_contract', name: '合同管理', code: 'enterprise:contracts', module: '企业管理', parentId: 'perm_enterprise', type: 'menu' },
  ...
  { id: 'perm_personnel', name: '人员管理', code: 'personnel', module: '人员管理', parentId: null, type: 'menu' },
  { id: 'perm_personnel_employee', name: '人员管理', code: 'personnel:employees', module: '人员管理', parentId: 'perm_personnel', type: 'menu' },
  { id: 'perm_personnel_employee_edit', name: '编辑人员', code: 'personnel:employees:edit', module: '人员管理', parentId: 'perm_personnel_employee', type: 'action' },
  { id: 'perm_attendance_group', name: '考勤组管理', code: 'attendance:groups', module: '人员管理', parentId: 'perm_personnel', type: 'menu' },
  { id: 'perm_personnel_contract', name: '合同管理', code: 'personnel:contracts', module: '人员管理', parentId: 'perm_personnel', type: 'menu' },
  { id: 'perm_personnel_insurance', name: '保险管理', code: 'personnel:insurance', module: '人员管理', parentId: 'perm_personnel', type: 'menu' },

  { id: 'perm_schedule', name: '排班管理', code: 'schedule', module: '排班管理', parentId: null, type: 'menu' },
  { id: 'perm_attendance_schedule', name: '排班管理', code: 'attendance:schedule', module: '排班管理', parentId: 'perm_schedule', type: 'menu' },
  { id: 'perm_attendance_schedule_publish', name: '发布排班', code: 'attendance:schedule:publish', module: '排班管理', parentId: 'perm_attendance_schedule', type: 'action' },
  { id: 'perm_schedule_attendance_data', name: '考勤数据', code: 'schedule:attendance-data', module: '排班管理', parentId: 'perm_schedule', type: 'menu' },
  { id: 'perm_schedule_attendance_exception', name: '考勤审批', code: 'schedule:attendance-exceptions', module: '排班管理', parentId: 'perm_schedule', type: 'menu' },
  { id: 'perm_schedule_cancel_shift_records', name: '取消班次记录', code: 'schedule:cancel-shift-records', module: '排班管理', parentId: 'perm_attendance_schedule', type: 'action' },

  { id: 'perm_grab', name: '抢班管理', code: 'grab', module: '抢班管理', parentId: null, type: 'menu' },
  ...
  { id: 'perm_task_approval', name: '任务审批', code: 'task:approval', module: '任务管理', parentId: 'perm_task', type: 'menu' },
  ...
  { id: 'perm_payroll_settlement', name: '发薪管理', code: 'payroll:settlement', module: '财税管理', parentId: 'perm_payroll', type: 'menu' },
  ...
  { id: 'perm_statistics', name: '分析统计', code: 'statistics', module: '分析统计', parentId: null, type: 'menu' },
  { id: 'perm_statistics_overview', name: '概览看板', code: 'statistics:overview', module: '分析统计', parentId: 'perm_statistics', type: 'menu' },
  { id: 'perm_statistics_recruitment', name: '招聘分析', code: 'statistics:recruitment', module: '分析统计', parentId: 'perm_statistics', type: 'menu' },
  { id: 'perm_statistics_attendance', name: '考勤分析', code: 'statistics:attendance', module: '分析统计', parentId: 'perm_statistics', type: 'menu' },
  { id: 'perm_statistics_task', name: '任务分析', code: 'statistics:task', module: '分析统计', parentId: 'perm_statistics', type: 'menu' },
  { id: 'perm_statistics_settlement', name: '结算分析', code: 'statistics:settlement', module: '分析统计', parentId: 'perm_statistics', type: 'menu' },
  { id: 'perm_statistics_export', name: '导出报表', code: 'statistics:export', module: '分析统计', parentId: 'perm_statistics', type: 'action' },
  ...
  { id: 'perm_system_reminder', name: '提醒规则配置', code: 'system:reminder-rules', module: '系统设置', parentId: 'perm_system', type: 'menu' },
  { id: 'perm_system_reminder_edit', name: '编辑提醒规则', code: 'system:reminder-rules:edit', module: '系统设置', parentId: 'perm_system_reminder', type: 'action' },
...
export const platformMenuPermissionDefs: Omit<MenuPermissionEntry, 'view' | 'edit'>[] = [
  ...
  { code: 'personnel', name: '人员管理', module: '人员管理' },
  { code: 'schedule', name: '排班管理', module: '排班管理' },
  { code: 'grab', name: '抢班管理', module: '抢班管理' },
  ...
  { code: 'system:reminder-rules', name: '提醒规则配置', module: '系统设置' },
